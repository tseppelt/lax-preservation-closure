...
type: definition
---
Two properties an equivalence relation $\equiv$ on finite simple graphs may have.

It is *preserved under disjoint unions* if $G \equiv G'$ and $H \equiv H'$ imply
$G + H \equiv G' + H'$. It is *preserved under taking complements* if $G \equiv H$ implies
$\overline{G} \equiv \overline{H}$; since complementation is an involution and $\equiv$ is
symmetric, this one implication already gives the biconditional of the paper.
