...
theorem IsEdgeContractionClosed.preservedUnderCompl (hd : IsEdgeDeletionClosed 𝓕)
    (hc : IsEdgeContractionClosed 𝓕) : PreservedUnderCompl (homIndRel 𝓕) := by
  classical
...
theorem PreservedUnderCompl.cl_mem_deleteEdges_singleton (hp : PreservedUnderCompl (homIndRel 𝓕))
...
theorem PreservedUnderCompl.cl_mem_contractionQuotient_singleton (hp : PreservedUnderCompl (homIndRel 𝓕))
...
theorem PreservedUnderCompl.cl_isMinorClosed (hp : PreservedUnderCompl (homIndRel 𝓕)) :
    IsMinorClosed (cl 𝓕) :=
...
theorem PreservedUnderCompl.of_cl_isMinorClosed (h : IsMinorClosed (cl 𝓕)) :
    PreservedUnderCompl (homIndRel 𝓕) := by
