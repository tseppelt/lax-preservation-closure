...
theorem PreservedUnderDisjointUnion.mem_cl_sigmaOn (hp : PreservedUnderDisjointUnion 𝓕)
...
theorem PreservedUnderDisjointUnion.cl_isSummandClosed (hp : PreservedUnderDisjointUnion 𝓕) :
